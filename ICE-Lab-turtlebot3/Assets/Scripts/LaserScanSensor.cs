...
public class LaserScanSensor : MonoBehaviour
{
    ...
    public void EndScan()
    {
        ...
        // we can't use  % 360f  here because it will break the costant phase between the two angles
    ...
    public void Update()
    {
		...
		measurementsSoFar = Mathf.Min(measurementsSoFar, NumMeasurementsPerScan);
